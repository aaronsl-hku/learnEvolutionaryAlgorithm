...
Copied and modified from https://developers.google.com/optimization/routing/tsp
"""
...
def create_data_model(distance_matrix=DISTANCE_MATRIX, num_vehicles=NUM_VEHICLES, depot=0):
