...
def on_generation(ga_instance):
    ...
    fitness = ga_instance.best_solutions_fitness[generation-1]
    prev_fitness = 0 if generation == 1 else ga_instance.best_solutions_fitness[generation - 2]
    change = fitness - prev_fitness
    print(f"Generation = {generation:>4}", end = '; ')
    print(f"Fitness    = {fitness:>6.2f}", end = '; ')
